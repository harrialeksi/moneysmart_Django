...
app_name = "cards"
urlpatterns = [
    path("travel-insurance", views.insurances, name="insurances"),
    path("coronavirus-ms", views.best_covid_19, name="best_covid_19"),
    path("flight-delay-cancellation", views.flight_delay, name="flight_delay"),
    path("overseas-spending", views.overseas_spending, name="overseas_spending"),
