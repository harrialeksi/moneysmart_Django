    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='account_usp', to='accounts.account')),
            ],
        ),
        migrations.AddField(
            model_name='account',
            name='provider',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='provider', to='accounts.provider'),
        ),
    ]
